...
import 'package:flutter_application_1_seller/models/category_model.dart';
...
class ProductsController extends GetxController {
  ...
  var pquantityComtroller = TextEditingController();
  ...
  uploadProduct(context) async {
    ...
    await store.set({
      ...
      'p_quantity': pquantityComtroller.text,
